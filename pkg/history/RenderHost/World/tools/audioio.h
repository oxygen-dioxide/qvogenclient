...
//-----------------------------------------------------------------------------
void WORLD_API wavwrite(const double *x, int x_length, int fs, int nbit,
  const char *filename);
...
//-----------------------------------------------------------------------------
int WORLD_API GetAudioLength(const char *filename);
...
//-----------------------------------------------------------------------------
void WORLD_API wavread(const char* filename, int *fs, int *nbit, double *x);
