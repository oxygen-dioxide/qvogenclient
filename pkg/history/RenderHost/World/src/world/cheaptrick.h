...
//-----------------------------------------------------------------------------
void WORLD_API CheapTrick(const double *x, int x_length, int fs,
...
//-----------------------------------------------------------------------------
void WORLD_API InitializeCheapTrickOption(int fs, CheapTrickOption *option);
...
//   FFT size
//-----------------------------------------------------------------------------
int WORLD_API GetFFTSizeForCheapTrick(int fs, const CheapTrickOption *option);
...
//   Lower f0 limit (Hz)
//-----------------------------------------------------------------------------
double WORLD_API GetF0FloorForCheapTrick(int fs, int fft_size);
