...
//   f0                   : F0 contour.
//-----------------------------------------------------------------------------
void WORLD_API Harvest(const double *x, int x_length, int fs,
...
//-----------------------------------------------------------------------------
void WORLD_API InitializeHarvestOption(HarvestOption *option);
...
//-----------------------------------------------------------------------------
int WORLD_API GetSamplesForHarvest(int fs, int x_length, double frame_period);
