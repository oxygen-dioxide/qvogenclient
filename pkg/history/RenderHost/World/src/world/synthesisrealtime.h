...
//-----------------------------------------------------------------------------
void WORLD_API InitializeSynthesizer(int fs, double frame_period, int fft_size,
...
//   1: True, 0: False.
//-----------------------------------------------------------------------------
int WORLD_API AddParameters(double *f0, int f0_length, double **spectrogram,
  double **aperiodicity, WorldSynthesizer *synth);

//-----------------------------------------------------------------------------
// RefreshSynthesizer() sets the parameters to default.
//-----------------------------------------------------------------------------
void WORLD_API RefreshSynthesizer(WorldSynthesizer *synth);

//-----------------------------------------------------------------------------
// DestroySynthesizer() release the memory.
//-----------------------------------------------------------------------------
void WORLD_API DestroySynthesizer(WorldSynthesizer *synth);
