...
//-----------------------------------------------------------------------------
void WORLD_API fftshift(const double *x, int x_length, double *y);
...
//   Lengths of index and edges must be the same.
//-----------------------------------------------------------------------------
void WORLD_API histc(const double *x, int x_length, const double *edges,
...
//-----------------------------------------------------------------------------
void WORLD_API interp1(const double *x, const double *y, int x_length, const double *xi,
...
//   y          : Output signal
//-----------------------------------------------------------------------------
void WORLD_API decimate(const double *x, int x_length, int r, double *y);
...
//   y    : Rounded value
//-----------------------------------------------------------------------------
int WORLD_API matlab_round(double x);
...
//   y          : Output signal
//-----------------------------------------------------------------------------
void WORLD_API diff(const double *x, int x_length, double *y);
...
//-----------------------------------------------------------------------------
void WORLD_API interp1Q(double x, double shift, const double *y, int x_length,
...
//   y                : Calculated result.
//-----------------------------------------------------------------------------
void WORLD_API fast_fftfilt(const double *x, int x_length, const double *h, int h_length,
...
//-----------------------------------------------------------------------------
double WORLD_API matlab_std(const double *x, int x_length);
