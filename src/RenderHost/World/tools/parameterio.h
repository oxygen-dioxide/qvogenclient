...
#include "../src/world/macrodefinitions.h"
...
//-----------------------------------------------------------------------------
void WORLD_API WriteF0(const char *filename, int f0_length, double frame_period,
...
//-----------------------------------------------------------------------------
int WORLD_API ReadF0(const char *filename, double *temporal_positions, double *f0);
...
//-----------------------------------------------------------------------------
double WORLD_API GetHeaderInformation(const char *filename, const char *parameter);
...
//-----------------------------------------------------------------------------
void WORLD_API WriteSpectralEnvelope(const char *filename, int fs, int f0_length,
...
// Note: Memory must be allocated before calling this function.
//-----------------------------------------------------------------------------
int WORLD_API ReadSpectralEnvelope(const char *filename, double **spectrogram);
...
//   spectrogram          : Spectral envelope estimated by CheapTrick
//-----------------------------------------------------------------------------
void WORLD_API WriteAperiodicity(const char *filename, int fs, int f0_length,
  double frame_period, int fft_size, int number_of_dimensions,
...
// Note: Memory must be allocated before calling this function.
//-----------------------------------------------------------------------------
int WORLD_API ReadAperiodicity(const char *filename, double **aperiodicity);
