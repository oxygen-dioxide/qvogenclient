...
//-----------------------------------------------------------------------------
int WORLD_API GetNumberOfAperiodicities(int fs);
...
//-----------------------------------------------------------------------------
void WORLD_API CodeAperiodicity(const double * const *aperiodicity, int f0_length,
...
//-----------------------------------------------------------------------------
void WORLD_API DecodeAperiodicity(const double * const *coded_aperiodicity,
...
//-----------------------------------------------------------------------------
void WORLD_API CodeSpectralEnvelope(const double * const *spectrogram, int f0_length,
...
//   spectrogram
//-----------------------------------------------------------------------------
void WORLD_API DecodeSpectralEnvelope(const double * const *coded_spectral_envelope,
