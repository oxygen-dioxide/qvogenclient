...
namespace Qs {
    ...
    // Modules
    const char MIME_CLIPBOARD_NOTE[] = "application/qvogenclient/notes";

    const char FILE_HEAD_DUMP[] = "qsdump";

    const char DIR_NAME_TEMP[] = "QVogenTemp";
    const char DIR_NAME_TEMP_PREFIX[] = "qs";
    const char KEY_NAME_MEMORY_PREFIX[] = "QVogen_Memory_";

    const char LOCAL_SERVER_NAME[] = "QVogen_Local_Host_V2";
