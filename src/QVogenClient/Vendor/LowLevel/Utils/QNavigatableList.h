#ifndef QNAVIGATABLELIST_H
#define QNAVIGATABLELIST_H
...
class QNavigatableList : public std::set<_Kty, _Pr, _Alloc> {
public:
...
public:
    ...
    QNavigatableList(_Mybase &&_Right, const allocator_type &_Al) : _Mybase(std::move(_Right), _Al) {
    }
